...
parser.add_argument('--input', dest='inDir',
                    action='store',
                    default=conf.IN_DIR,
                    help=f'Path that contain all the input file, default {conf.IN_DIR}')
parser.add_argument('--output', dest='outDir',
                    action='store',
                    default=conf.OUT_DIR,
                    help=f'Path that contain all outputfile, default {conf.OUT_DIR}')
parser.add_argument('--outEncode', dest='outEncode',
                    action='store',
                    default=conf.OUT_ENCODE,
                    help='Set the default encode for command output')
args = parser.parse_args()

# Overide it again, and use this as global config state
