...
func (core *ServiceCore) WebsocketConnectionCreateRuntime(req *WebsocketRequestCreateRepl) (, error) {
	core.muConnClients.Lock()
	defer core.muConnClients.Unlock()
...
func (core *ServiceCore) WebsocketConnectionEvaluation(conn *websocket.Conn) (string, error) {
	core.muConnClients.Lock()
	defer core.muConnClients.Unlock()
